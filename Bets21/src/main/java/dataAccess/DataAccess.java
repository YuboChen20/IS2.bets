...
public class DataAccess  {
	...
	public void initializeDB(){
		...
		try {
		   ...
		   if (month==12) { month=0; year+=1;}  
			...
			q7=ev21.addQuestion("�Habr� goles en la primera parte?",2);
			...
			Usuario admi1= new Usuario("Silvia","contrase�a",null,true,null);
		...
		//	this.a�adirApuesta(user, apuesta1);
		//	this.a�adirApuesta(user, apuesta2);			
	...
	public void a�adirApuesta(Usuario user,Bet ap) {
		db.getTransaction().begin();
